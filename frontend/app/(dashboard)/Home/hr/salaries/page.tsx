    ...
    <main className="content">
      <header className="main-header">
        <div className="breadcrumb">
          Payroll / <strong>Salary Profile</strong>
        </div>
      ...
      <section className="staff-header-card">
        <div className="staff-info">
          <div className="staff-avatar-lg" style={{ background: "#E0F2FE" }}>
            RM
          </div>
          <div className="staff-details">
            ...
            <p>
              ID: <strong>TCH-2021-112</strong> • Mathematics Dept • Senior
              Teacher
            </p>
          </div>
        </div>
          ...
          <tbody>
            <tr>
              ...
              <td className="text-right">
                <Link href="/Home/hr/salaries/profile/">
                  <button className="btn-text">View Payslip</button>
                </Link>
              </td>
            </tr>
            <tr>
