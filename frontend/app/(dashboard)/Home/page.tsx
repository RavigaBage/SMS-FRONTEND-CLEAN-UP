          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            {loading ? (
              ...
              <>
                ...
                <KPICard
                  label="Attendance"
                  value={`${stats.active_attendance}%`}
                  icon={<Calendar />}
                />
                <KPICard
                  label="Fees Collected"
                  value={`$${stats.fees_collected.toLocaleString()}`}
                  icon={<DollarSign />}
                />
              </>
            )}
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-slate-50">
                  <tr>
                    {["Student", "Trans Ref", "Amount", "Method", "Date"].map(
                      (h) => (
                        <th
                          key={h}
                  ...
                  {loading ? (
                    ...
                    transactions.map((t) => (
                      <tr key={t.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-6 py-4 text-slate-500 text-sm font-mono uppercase">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {loading ? (
                ...
                <>
                  <Link href="/Home/profiles/students/">
                    <QuickBtn
                      icon={<Plus />}
                      label="Add Student"
                      color="bg-blue-600"
                  ...
                  <Link href="/Home/academics/grades/">
                    <QuickBtn
                      icon={<ClipboardList />}
                      label="Exam Result"
                  ...
                  <Link href="/Home/profiles/teachers&staff/">
                    <QuickBtn
                      icon={<MessageSquare />}
            ...
            {loading ? (
              ...
              <>
                ...
                <p className="text-xs text-slate-400 group-hover:text-slate-200">
                  Latency: 14ms. All modules running normally.
                </p>
              </>
            )}
          </div>
...
const QuickBtn = ({ icon, label, color }: any) => (
  <button
    className={`${color} w-full text-white p-4 rounded-2xl flex flex-col items-center gap-2`}
  >
