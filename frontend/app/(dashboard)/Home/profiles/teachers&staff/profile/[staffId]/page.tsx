        ...
        <div className="px-8 pb-8 flex flex-col md:flex-row items-end gap-6 -mt-12">
          ...
          <div className="flex-1 pb-2">
            ...
            <p className="text-slate-500 font-bold text-xs uppercase tracking-wider flex items-center gap-2">
              USERNAME: {currentStaff.full_name} •{" "}
              {currentStaff.staff_type_display} •{" "}
              {currentStaff.specialization || "General"}
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm">
            ...
            <div className="space-y-6">
              <DetailItem
                icon={<Calendar />}
                label="Date of Birth"
                value={currentStaff.date_of_birth || "Not Provided"}
              />
              <DetailItem
                icon={<Phone />}
                label="Phone Number"
                value={currentStaff.phone_number || "Not Provided"}
              />
              <DetailItem
                icon={<Mail />}
                label="Work Email"
              ...
              <DetailItem
                icon={<MapPin />}
                label="Address"
                value={currentStaff.address || "No address on file"}
              />
              <DetailItem
                icon={<Briefcase />}
                label="Joined School"
                value={currentStaff.employment_date || "Not Provided"}
              />
              <DetailItem
                icon={<Fingerprint />}
                label="National ID"
                value={currentStaff.national_id || "Pending Verification"}
              />
            </div>
        ...
        <div className="col-span-12 lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <StatCard
              ...
              value={currentStaff.user?.is_active ? "Active" : "Inactive"}
              trend="System Verified"
              icon={<Star size={18} className="text-amber-400" />}
            />
            <StatCard
              label="Joined"
              value={new Date(currentStaff.created_at).getFullYear().toString()}
              trend="Registry Year"
              icon={<Clock size={18} className="text-cyan-500" />}
            />
            <StatCard
              label="Gender"
              value={currentStaff.gender_display}
