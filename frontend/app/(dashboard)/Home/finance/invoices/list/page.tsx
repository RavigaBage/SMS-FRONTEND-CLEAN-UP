...
function SkeletonRow() {
  return (
    <div
      style={{
        display: "grid",
        gridTemplateColumns: "180px 1fr 100px 130px 130px 110px 120px",
        padding: "18px 24px",
  ...
  const summary = useMemo<InvoiceSummary>(
    () => ({
      ...
      totalCollected: invoices.reduce(
        (s, i) => s + parseFloat(i.amount_paid),
        0,
      ),
    ...
    >
      ...
      >
        ...
        <Link href="/Home/finance/invoices" passHref>
          ...
          >
            <span style={{ fontSize: 16, lineHeight: 1 }}>+</span> Generate
            Invoice
          </button>
        </Link>
      </div>
      ...
      <div style={{ maxWidth: 1300, margin: "0 auto", padding: "36px 40px" }}>
        ...
        >
          <SummaryCard
            ...
            accent="#6366f1"
            sub={`${invoices.length} shown this page`}
          />
          <SummaryCard
            label="Collected"
            icon="✅"
            ...
            sub={
              summary.totalBilled
                ? `${Math.round((summary.totalCollected / summary.totalBilled) * 100)}% of total`
                : "—"
            }
          />
          <SummaryCard
            ...
            {STATUS_FILTERS.map(({ value, label }) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 8,
                  border: "1px solid",
                  borderColor: statusFilter === value ? "#6366f1" : "#e5e7eb",
                  background: statusFilter === value ? "#eef2ff" : "#ffffff",
                  color: statusFilter === value ? "#4f46e5" : "#6b7280",
                  fontSize: 12,
                  fontWeight: 600,
                  cursor: "pointer",
                ...
                <div key={inv.id}>
                  <div
                    ...
                    style={{
                      display: "grid",
                      gridTemplateColumns:
                        "180px 1fr 100px 130px 130px 110px 120px",
                      padding: "16px 24px",
                      cursor: "pointer",
                      borderBottom: "1px solid #f1f5f9",
                    ...
                    >
                      ...
                      >
                        {[
                          ...
                          {
                            label: "Generated By",
                            value: inv.generated_by_username ?? "—",
                          },
                          {
                            label: "Last Updated",
                            value: fmtDate(inv.updated_at),
                          },
                        ].map(({ label, value }) => (
                          <div key={label}>
                            <div
