...
//     try {
//       const updated = await gradeApi.updateGradeByParams({
//         studentId: Number(studentId),
//         classId: Number(classId),
//         subjectId: Number(subjectId),
//         academicYear: academicYear,
...
//             <p>No grade record found for the specified parameters.</p>
//           </div>
//         </main>
//       </div>
//     );
...
const get_letter_grade = (score: number): string => {
  ...
  // Error state (only for critical errors like missing params)
  if (error) {
    return (
      <div className="dashboard-container STUDENT_GRADE">
        <main className="content">
