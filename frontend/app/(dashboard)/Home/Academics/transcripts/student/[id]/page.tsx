...
export default function StudentTranscript() {
  ...
  if (!student)
    return <div className="dashboardWrapper">Student not found</div>;
                    ...
                    >
                      ...
                      <div
                        style={{
                          fontSize: "20px",
                          fontWeight: "800",
                          color: rankColors[termRankValue] || defaultColor,
                        }}
                      >
                        ...
                        return (
                          <tr key={rec.id - index}>
                            ...
                            <td className="gradeCell">
                              <strong>{rec.grade_letter}</strong>
                            </td>
                            <td>
                              <span
                                style={{
      ...
      <div className="no-terms-wrap print-area">
        <div className="no-terms-card">
          ...
          <p className="no-terms-body">
            There are no academic terms set up for this year yet. Grades need to
