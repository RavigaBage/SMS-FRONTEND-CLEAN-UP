        ...
        >
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-[2] py-3 bg-cyan-600 text-white font-black rounded-xl hover:bg-cyan-700 transition-all text-[10px] uppercase tracking-widest flex items-center justify-center gap-2"
            >
              {loading ? (
