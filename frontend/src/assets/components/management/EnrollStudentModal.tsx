        ...
        <div className="px-10 py-6 border-b border-slate-50 flex justify-between items-center bg-slate-50/50">
          <div>
            ...
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">
              Profile Creation & Class Placement
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-8">
          ...
          <div className="space-y-4 pt-4 border-t border-slate-50">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <FormInput
                ...
                onChange={(v: any) =>
                  setFormData({ ...formData, enrollment_date: v })
                }
              />
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-2 py-4 bg-slate-900 text-white font-black rounded-2xl hover:bg-slate-800 shadow-xl shadow-slate-200 transition-all text-xs uppercase tracking-widest flex items-center justify-center gap-2"
            >
              {loading ? (
