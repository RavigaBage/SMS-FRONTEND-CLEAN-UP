...
export function EditStaffModal({ 
  ...
  <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 max-h-[85vh]"> {/* limit height */}
  ...
  <div className="grid grid-cols-2 gap-4">
    <FormInput
      ...
      onChange={(val: string) => setFormData({...formData, first_name: val})}
    />
    <FormInput
      label="Last Name"
  ...
  {/* Residential Address + Health Info side by side */}
  <div className="grid grid-cols-2 gap-4">
    <div className="flex flex-col">
      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
