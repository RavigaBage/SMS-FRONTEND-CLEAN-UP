...
export default function GradeEntry() {
  ...
  const subjectId =
    searchParams.get("subjectId") || searchParams.get("subject");
  ...
  const w_assessment = getWeighted(
    assessmentScore,
    assessmentTotal,
    WEIGHTS.ASSESSMENT,
  );
  ...
  const handleSaveGrades = async () => {
    ...
    try {
      ...
      setSaveStatus(
        `Error: ${err instanceof Error ? err.message : "Failed to save grades"}`,
      );
    } finally {
      setIsSaving(false);
    }
    ...
    <div className="dashboard-container STUDENT_GRADE">
      <main className="content">
        ...
        {isNewGrade && (
          ...
          >
            <strong>New Grade Entry:</strong> No existing grade found. Enter the
            scores below to create a new grade record.
          </div>
        )}
              ...
              <div className="exam-inputs" style={{ padding: "20px" }}>
                <div className="input-field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAssessmentScore(Number(e.target.value) || 0)
                    }
                ...
                <div className="input-field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAssessmentTotal(Number(e.target.value) || 0)
                    }
                    className="score-input"
                    step="0.01"
                  />
              ...
              <div style={{ padding: "20px" }}>
                ...
                <p
                  style={{
                    ...
                    textAlign: "right",
                    fontSize: 11,
                    color: remarks.length > 400 ? "#ef4444" : "#94a3b8",
                  }}
                >
                  {remarks.length} / 500
                </p>
              ...
              <div style={{ padding: "20px" }}>
                ...
                <div className="setting-item">
                  <div className="setting-label">
                    ...
                    <span
                      className={`grade-pill ${getGradeClass(get_letter_grade(displayScore))}`}
                    >
              ...
              {saveStatus && (
                <div
                  style={{
                    ...
                    padding: "10px",
                    borderRadius: "4px",
                    backgroundColor: saveStatus.includes("Error")
                      ? "#fee"
                      : "#efe",
