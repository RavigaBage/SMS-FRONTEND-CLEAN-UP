        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, staff_type: e.target.value })
                }
                className="w-full p-2.5 border border-slate-200 rounded-lg outline-none bg-white text-sm"
              >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              {errors.phone_number && (
                <p className="text-[10px] text-red-500 font-bold">
                  {getFirstError(errors.phone_number)}
                </p>
              )}
            </div>
            <div className="space-y-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              {errors.national_id && (
                <p className="text-[10px] text-red-500 font-bold">
                  {getFirstError(errors.national_id)}
                </p>
              )}
            </div>
            <div className="space-y-1">
              ...
              {errors.photo_url && (
                <p className="text-[10px] text-red-500 font-bold">
                  {getFirstError(errors.photo_url)}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-2.5 bg-slate-900 text-white text-sm font-bold rounded-lg hover:bg-slate-800 transition-all flex items-center justify-center gap-2 shadow-lg shadow-slate-200"
            >
              {loading ? (
