...
const ConfigurationIcon = (props) => (
  <IconBase id="grad-configuration" gradientFrom="#0EA5E9" gradientTo="#22D3EE" {...props}>
...
const AppAccessIcon = (props) => (
  <IconBase id="grad-appaccess" gradientFrom="#10B981" gradientTo="#059669" {...props}>
    <path d="M10 2 L18 5 V10 C18 14 14.5 17.5 10 19 C5.5 17.5 2 14 2 10 V5 L10 2 Z" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M6.5 10.5 L9 13 L14 8" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </IconBase>
);
...
const ArrowIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24">
    <path d="M8 5l8 7-8 7" fill="none" stroke="#64748b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export default function Sidebar() {
  ...
  const canSeeHR = isAdmin || isHeadmaster || isTeacher;
  const canSeeFinance = isAdmin || isHeadmaster;
  const canSeeSystem = isAdmin || isHeadmaster;
      ...
      <div className={styles.navSection}>
        ...
        {canSeeAcademic && (
          <div className={styles.navGroup}>
            ...
            >
              ...
              <span className={styles.navArrow}><ArrowIcon /></span>
            </div>

            {openMenu === "academic" && (
              <div className="submenu open">
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/Academics/enrollment/" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/Academics/subject" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/Academics/classes/" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  ...
                  href="/Home/Academics/grades/class" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  isTeacher={isTeacher} allowTeacher={true}
                  href="/Home/Academics/transcripts" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
        ...
        {canSeeTimetable && (
          <div className={styles.navGroup}>
            ...
            {openMenu === "timetable" && (
              <div className="submenu open">
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/Academics/timetable/" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><TimetableIcon /></div>
                    <span>Timetable</span>
                  </div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  isTeacher={isTeacher} allowTeacher={true}
                  href="/Home/Academics/syllabi/" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
          ...
          <div className={styles.navGroup}>
            ...
            {openMenu === "profiles" && (
              <div className="submenu open">
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  isTeacher={isTeacher} allowTeacher={true}
                  href="/Home/profiles/students" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><ProfilesIcon /></div>
                    <span>Students</span>
                  </div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/profiles/teachers&staff" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/profiles/teachers" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><StaffIcon /></div>
                    <span>Teachers</span>
                  </div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/profiles/parents" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><ProfilesIcon /></div>
                    <span>Parents</span>
                  </div>
        ...
        {canSeeHR && (
          <div className={styles.navGroup}>
            ...
            {openMenu === "hr" && (
              <div className="submenu open">
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/hr/staffAttendance" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><StaffIcon /></div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  isTeacher={isTeacher} allowTeacher={true}
                  href="/Home/management/studentManager" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><ProfilesIcon /></div>
        ...
        {canSeeFinance && (
          <div className={styles.navGroup}>
            ...
            {openMenu === "finance" && (
              <div className="submenu open">
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/finance/fees" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><FinanceIcon /></div>
                    <span>Fees</span>
                  </div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/finance/expenditure" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><FinanceIcon /></div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/finance/invoices/list/" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><TranscriptIcon /></div>
                    <span>Invoices</span>
                  </div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/finance/payments" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><FinanceIcon /></div>
                    <span>Payments</span>
                  </div>
                ...
                <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
                  href="/Home/finance/payroll" className={styles.submenuItem}>
                  <div className={styles.navItemContent}>
                    <div className={styles.navIcon}><FinanceIcon /></div>
                    <span>Payroll</span>
                  </div>
        ...
        {canSeeSystem && (
          <>
            ...
            <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
              href="/Home/userAccount/" className={styles.navItem}>
              <div className={styles.navItemContent}>
                <div className={styles.navIcon}><ProfilesIcon /></div>
            ...
            <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
              href="/Home/config/" className={styles.navItem}>
              <div className={styles.navItemContent}>
            ...
            <ProtectedLink isAdmin={isAdmin} isHeadmaster={isHeadmaster}
              href="/Home/appaccess/" className={styles.navItem}>
              <div className={styles.navItemContent}>
