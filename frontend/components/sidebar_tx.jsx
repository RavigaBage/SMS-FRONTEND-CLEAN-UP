...
const TranscriptIcon = (props) => (
  ...
  >
    <path
      d="M9 0H2a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7l-7-7z"
      fill="none"
    />
...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    if (role) {
      ...
      if (lowerRole !== "admin" && lowerRole !== "headmaster") {
        window.location.href = "/Home/teacher_auth/";
        return;
      }
    }
    setIsLoading(false);
  ...
  if (isLoading || (!isAdmin && !isHeadmaster && userRole === "teacher")) {
    return (
      <div className={styles.sidebar}>
        ...
        <div style={{ padding: "20px", textAlign: "center", color: "#94a3b8" }}>
          <p style={{ fontSize: "14px" }}>Redirecting...</p>
        </div>
      </div>
    );
  }
